...
apply {{} {
	...
	foreach m {error.tcl document.tcl dispatch.tcl fs.tcl conf.tcl secret.tcl theme.tcl exec.tcl git.tcl project.tcl workspace.tcl diff.tcl tls.tcl http.tcl sig.tcl agent-prompt.tcl agent-settings.tcl agent.tcl agent-tools.tcl agent-allow.tcl provider.tcl \
