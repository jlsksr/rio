...
apply {{} {
	...
	foreach m {error.tcl document.tcl dispatch.tcl fs.tcl conf.tcl secret.tcl theme.tcl exec.tcl git.tcl project.tcl workspace.tcl diff.tcl agent-prompt.tcl agent.tcl agent-tools.tcl \
