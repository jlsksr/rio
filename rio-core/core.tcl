...
apply {{} {
	...
	foreach m {error.tcl document.tcl dispatch.tcl fs.tcl conf.tcl theme.tcl exec.tcl git.tcl \
			ops-buffer.tcl ops-fs.tcl ops-undo.tcl ops-session.tcl ops-theme.tcl ops-exec.tcl ops-git.tcl} {
