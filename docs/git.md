...
The git pane: seeing what changed, staging it, and committing — without leaving
the editor.
...
For now, the *Files & git* entry under **What works now** in
[README.md](../README.md) describes what the pane does today.
